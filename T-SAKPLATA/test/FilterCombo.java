 ...
 *
 * 1. Focus the combo
 * 2. Type a character sequence
 * 3. With each key press the box will update itself filtering out the items that do
 *    not match the users character sequence.
 * 
 * Note 1:
 * The user can press the left and right arrow keys to move forward and backward
 * in the filter character sequence.
 *
 * Note 2:
 * The user can press the "Back Space", "Delete", or "Escape" keys to restore the
 * original values and reset the filtering sequence.
 *
 * Enjoy!
 * 
